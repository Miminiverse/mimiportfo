...
const About = () => {
  return (
    ...
    <div className="max-w-6xl mx-auto px-5 mt-10 text-center">
      ...
      <br />
      <div>
        <p> Hi,  I'm Minh Tam --- currently an international student in the US</p>
        <p>I am persuing a career to be a web developer </p>
        <p>I am inspired by beautiful and well-functional websites </p>
       
        <Link target="_blank" className="no-underline pr-4 inline-block text-accent text-yellow-400 text-center"to={'/resume'}>
            <div className="flex">
            <FcIdea size={20}/> <span><strong>Click me for resume, please!</strong></span> <FcIdea size={20}/>
            </div>
        </Link>
        <br />
        <br />
